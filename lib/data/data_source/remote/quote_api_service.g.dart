...
class _QuoteApiService implements QuoteApiService {
  ...
  Future<HttpResponse<QuoteModel>> getAQuote({
    String apiKey = Url.xRapidAPIKey,
    String apiHost = Url.xRapidAPIHost,
  }) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<QuoteModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = QuoteModel.fromJson(_result.data!);
